        ...
        >
            <div className="w-10/12 lg:w-6/12 flex flex-col h-full my-24  lg:m-0 lg:justify-center ">
                ...
                <div className="py-5 lg:py-10 space-y-4">
                    <p className="font-poppins text-primary text-xl md:text-xl">
                    ...
                    <p className="font-poppins text-primary text-lg md:text-xl">
                    ...
                    <p className="font-poppins flex flex-col text-primary text-lg md:text-xl space-y-1">
